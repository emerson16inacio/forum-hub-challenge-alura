...
Este projeto é uma **API REST** desenvolvida como parte do Challenge Back-End da **Alura**. A aplicação simula o funcionamento de um fórum, permitindo o gerenciamento de tópicos (CRUD) e incluindo um sistema robusto de autenticação e segurança.
...
- **CRUD de Tópicos:**
    ...
    - Exclusão de tópicos (soft delete ou físico).
- **Documentação:**
    - Interface Swagger UI (`/swagger-ui.html`) automatizada.
...
1. Clone este repositório:
   ```bash
   git clone [https://github.com/emerson16inacio/forum-hub-challenge.git](https://github.com/emerson16inacio/forum-hub-challenge.git)